...
#
# recreate.tcl: Tcl script for re-creating project 'projmode-led8'
#
# Generated by Vivado on Mon Nov 20 19:57:14 GMT 2017
...
#
#    "~/eg-zc702/vivado/projmode-led8/projmode-led8.srcs/sources_1/bd/led8/hdl/led8_wrapper.v"
#    "~/eg-zc702/vivado/projmode-led8/projmode-led8.srcs/constrs_1/led8.xdc"
#    "~/eg-zc702/vivado/projmode-led8/projmode-led8.srcs/sim_1/imports/led8/zynq_tb.v"
#
...
# Set the reference directory to where this script is
...
set project_name "projmode-led8"
...
set files [list \
 "[file normalize "$origin_dir/projmode-led8.srcs/sources_1/bd/led8/hdl/led8_wrapper.v"]"\
]
...
set_property -name "top" -value "led8_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/projmode-led8.srcs/constrs_1/led8.xdc"]"
...
# Import local files from the original project
set files [list \
 "[file normalize "$origin_dir/projmode-led8.srcs/sim_1/imports/led8/zynq_tb.v"]"\
]
...
# Proc to create BD led8
proc cr_bd_led8 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name led8
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
# End of cr_bd_led8()
cr_bd_led8 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files led8.bd ]
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files led8.bd ]
set_property IS_ENABLED "1" [get_files led8.bd ]
set_property IS_GLOBAL_INCLUDE "0" [get_files led8.bd ]
set_property IS_LOCKED "0" [get_files led8.bd ]
set_property LIBRARY "xil_defaultlib" [get_files led8.bd ]
set_property PATH_MODE "RelativeFirst" [get_files led8.bd ]
set_property PFM_NAME "" [get_files led8.bd ]
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files led8.bd ]
set_property USED_IN "synthesis implementation simulation" [get_files led8.bd ]
set_property USED_IN_IMPLEMENTATION "1" [get_files led8.bd ]
set_property USED_IN_SIMULATION "1" [get_files led8.bd ]
set_property USED_IN_SYNTHESIS "1" [get_files led8.bd ]

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part ${zc702_part} -flow {Vivado Synthesis 2017} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part ${zc702_part} -flow {Vivado Implementation 2017} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
