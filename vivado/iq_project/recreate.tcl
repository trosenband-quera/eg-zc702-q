...
#
# recreate.tcl: Tcl script for re-creating the project
#
...
set _xil_proj_name_ "iq-demod-zynq"
...
set file "[file normalize ${origin_dir}/srcs/constrs_1/imports/constrs_1/top.xdc]"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/srcs/sim_1/imports/top/zynq_tb.v" ]\
]
